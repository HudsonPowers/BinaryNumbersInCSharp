...
Which of the following are integers:
   ...
   * "hello" | ADD ANSWER HERE - NO
   * 17.5 | ADD ANSWER HERE - NO
   * 60009 - YES
   * 22333 - YES
   * -33.5f - NO
   * 'c' - NO
...
* Each of the following numbers are 8-bit signed integers. For each, convert 
  ...
  * `0xAB` - 10101011 - negative
  * `0xFD` - 1101111 - negative
  * `0xF1` - 11100001 - negative
  * `0xBD` - 10111111 - negative
...
* Using 4-bit signed integers: -7 - 2 No Error (This will result in an
  Underflow error.)
